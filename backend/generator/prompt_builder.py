...
╔═══════════════════════════════════════════════════════════════╗
║ ТРЕБОВАНИЯ К HTML (МИНИМУМ 500+ СТРОК)                        ║
╚═══════════════════════════════════════════════════════════════╝
...
╔═══════════════════════════════════════════════════════════════╗
║ ТРЕБОВАНИЯ К CSS (МИНИМУМ 300+ СТРОК)                         ║
╚═══════════════════════════════════════════════════════════════╝

1. ОБЯЗАТЕЛЬНО ВКЛЮЧИ:
   • CSS переменные (:root {{ --primary-color: ... }})
...
3. НЕ ДОПУСКАЙ:
   ❌ Пустой CSS файл
   ❌ Меньше 100 строк кода
   ❌ Только комментарии

╔═══════════════════════════════════════════════════════════════╗
║ ТРЕБОВАНИЯ К JAVASCRIPT (МИНИМУМ 150+ СТРОК)                  ║
╚═══════════════════════════════════════════════════════════════╝
...
1. ОБЯЗАТЕЛЬНЫЙ ФУНКЦИОНАЛ:
   ...
   ✓ Карусели (галерея, отзывы) с центрированием
   ✓ Плавные анимации при скролле
   ✓ Обработка отправки форм

2. ТАЙМЕР:
   • Обратный отсчет 24 часа
   • Обнуление каждый день в 00:00
   • Формат: ЧЧ:ММ:СС
   • Обновление каждую секунду

3. НЕ ДОПУСКАЙ:
   ❌ Пустой JS файл
   ❌ Меньше 50 строк кода
   ❌ Только комментарии
...
✓ HTML должен быть ПОЛНЫМ (от <!DOCTYPE> до </html>)
✓ CSS должен быть ПОЛНЫМ (минимум 300 строк)
✓ JS должен быть ПОЛНЫМ (минимум 150 строк)
