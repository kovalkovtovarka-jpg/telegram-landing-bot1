...
class TemplateSelector:
    ...
    def __init__(self, templates_path: str, logic_path: str):
        """
        Инициализация селектора
        
        Args:
            templates_path: Путь к файлу landing-templates.json
            logic_path: Путь к файлу template-selection-logic.json
        """
